...
final ratesProvider = FutureProvider.autoDispose<Map<String, int>>((ref) {
  final svc = ref.watch(firestoreServiceProvider);
  return svc.loadRates();
});

// Derived: amount for a given (type, package) selection
final selectedAmountProvider = Provider.autoDispose.family<int, ({String vehicleType, String packageId})>(
  (ref, args) {
